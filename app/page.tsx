...
import { Upload, FileText, MessageSquare, FileCheck, Briefcase, DollarSign, Sparkles, TrendingUp, Home as HomeIcon } from "lucide-react" // Renamed Home to HomeIcon to avoid conflict
...
// These keys are used across your component suite.
// ===============================================
const LOCAL_STORAGE_KEYS = [
    "global_job_description",    // JD_KEY
    "global_company_name",       // COMPANY_KEY
    "ats_analysis_result",       // ANALYSIS_RESULT_KEY
    "ai_advisor_chat_history",   // CHAT_HISTORY_KEY
    "interview_prep_result",     // INTERVIEW_PREP_KEY
    "salary_insights_result",    // SALARY_INSIGHTS_KEY
];

/**
 * Clears all persistent application state from Local Storage.
 */
...
export default function Home() {
    ...
    const handleBackToHome = () => {
        ...
        // 2. CLEAR ALL LOCAL STORAGE DATA (New logic)
                        ...
                        <div id="tabs-section" className="space-y-6">
                            ...
                            <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-10">
                                ...
                                <TabsContent value="salary" className="space-y-4">
                                    {/* Note: This component relies on the QueryClientProvider being set up in the layout */}
